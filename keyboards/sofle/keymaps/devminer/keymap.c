...
[_RAISE] = LAYOUT(
  ...
  _______, KC_INS,  SGUI(KC_S), SGUI(KC_4), KC_APP,  KC_NO,                                KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_DEL,
...
[_ADJUST] = LAYOUT(
  ...
  KC_CAPS, KC_QWERTY, KC_GAME, KC_NO,   KC_NO,   KC_NO,                                 KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_DLINE,
